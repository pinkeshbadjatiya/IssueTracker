...
ActiveRecord::Schema.define(version: 20150905031513) do
  ...
  add_index "comments", ["tags_id"], name: "index_comments_on_tags_id"
  ...
  add_index "members", ["post_id"], name: "index_members_on_post_id"
